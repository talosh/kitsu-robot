...
///////////////////////////////////////////////////////////////////////////////
//
// FilmLight API bindings for JavaScript
// Uses WebSockets
//
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
...
flapi.Library = class Library {
    ...
    register_value_type( name, cls )
    {
        this.ValueTypes[name] = cls;
    }
...
flapi.library = new flapi.Library();
...
flapi.Interface = class Interface {
...
flapi.library.register_value_type( "timecode", flapi.Timecode );

///////////////////////////////////////////////////////////////////////////////
//
// Keycode

flapi.Keycode = class Keycode {
    constructor( obj )
    {
...
flapi.library.register_value_type( "keycode", flapi.Keycode );

///////////////////////////////////////////////////////////////////////////////
//
// FrameNumber

flapi.FrameNumber = class FrameNumber {
    constructor(obj)
    {
...
flapi.library.register_value_type( "framenumber", flapi.FrameNumber );
...
flapi.Connection = class Connection {
    ...
    constructor(url)
    {
         ...
         */
        var classes = flapi.library.get_classes();
        for( var ix in classes )
        {
            var clsname = classes[ix];
            this[clsname] = flapi.library.create_instance( clsname, this, null );
        }
    }
     ...
     *      Promise
     *
     * You can use 'await' on the resulting Promise to block 
    ...
    /* close()
     *
     * Closes socket connect to FilmLight API server.
     */
    close()
    {
        if( this.socket != null )
    ...
    /* get_username()
     * 
     * Return Promise will will resolve to the username used to login to API server.
     */
    get_username()
    {
        return this.call( null, "get_username", null );
    }

    /* get_permissions()
     * 
     * Return a Promise which will resolve to a set of permissions 
     * supported by connection.
     * 
     * Permissions are defined by the server for the user that this connection
     * is authenticated as.
     *
     */
    get_permissions()
    ...
    handle_message(event)
    {
        ...
        var reply = JSON.parse( event.data, (k,v) => { return this.decode_obj(k,v) } );
        ...
        if( reply.method == "signal" )
        {
            ...
            {
                console.log( "signal message has no target" );
                return;
            }
            ...
            if( obj == null )
            {
                console.log( "object for signal target id " + reply.target + " cannot be found" );
                return;
            }
    ...
    decode_obj( k, v )
    {
        if( v != null && typeof v === 'object' )
        {
            if( v._handle != null )
            {
                ...
                /* Create new handle */
                o = flapi.library.create_instance( v._handle, this, v._id );
            ...
            {
                var vto = flapi.library.create_value_type( v._type, v );
                if( vto == null )
    ...
    call( target, method, params )
    {
        return new Promise( (resolve,reject) => {
            ...
            /* when message returns/fails, Connection will invoke resolve/reject */
        });
    }
...
flapi.APITest = class APITest extends flapi.Interface {
...
flapi.library.register_class( 'APITest', flapi.APITest )
...
flapi.Application = class Application extends flapi.Interface {
...
flapi.AudioSync = class AudioSync extends flapi.Interface {
...
flapi.CurrentGrade = class CurrentGrade extends flapi.Interface {
...
flapi.library.register_class( 'CurrentGrade', flapi.CurrentGrade )
...
flapi.Cursor = class Cursor extends flapi.Interface {
...
flapi.library.register_class( 'Cursor', flapi.Cursor )
...
flapi.Diagnostics = class Diagnostics extends flapi.Interface {
...
flapi.library.register_class( 'Diagnostics', flapi.Diagnostics )
...
flapi.DynamicDialog = class DynamicDialog extends flapi.Interface {
...
flapi.library.register_class( 'DynamicDialog', flapi.DynamicDialog )
...
flapi.Export = class Export extends flapi.Interface {
...
flapi.library.register_class( 'Export', flapi.Export )
...
flapi.Filesystem = class Filesystem extends flapi.Interface {
...
flapi.library.register_class( 'Filesystem', flapi.Filesystem )
...
flapi.Format = class Format extends flapi.Interface {
...
flapi.library.register_class( 'Format', flapi.Format )
...
flapi.FormatBurnin = class FormatBurnin extends flapi.Interface {
...
flapi.library.register_class( 'FormatBurnin', flapi.FormatBurnin )
...
flapi.FormatSet = class FormatSet extends flapi.Interface {
...
flapi.library.register_class( 'FormatSet', flapi.FormatSet )
...
flapi.Image = class Image extends flapi.Interface {
...
flapi.library.register_class( 'Image', flapi.Image )
...
flapi.ImageSearcher = class ImageSearcher extends flapi.Interface {
...
flapi.library.register_class( 'ImageSearcher', flapi.ImageSearcher )
...
flapi.JobManager = class JobManager extends flapi.Interface {
...
flapi.library.register_class( 'JobManager', flapi.JobManager )
...
flapi.Licence = class Licence extends flapi.Interface {
...
flapi.library.register_class( 'Licence', flapi.Licence )
...
flapi.Mark = class Mark extends flapi.Interface {
...
flapi.library.register_class( 'Mark', flapi.Mark )
...
flapi.Menu = class Menu extends flapi.Interface {
...
flapi.library.register_class( 'Menu', flapi.Menu )
...
flapi.MenuItem = class MenuItem extends flapi.Interface {
...
flapi.library.register_class( 'MenuItem', flapi.MenuItem )
...
flapi.MultiPaste = class MultiPaste extends flapi.Interface {
...
flapi.library.register_class( 'MultiPaste', flapi.MultiPaste )
...
flapi.ProgressDialog = class ProgressDialog extends flapi.Interface {
...
flapi.library.register_class( 'ProgressDialog', flapi.ProgressDialog )
...
flapi.QueueManager = class QueueManager extends flapi.Interface {
...
flapi.library.register_class( 'QueueManager', flapi.QueueManager )
...
flapi.RenderProcessor = class RenderProcessor extends flapi.Interface {
...
flapi.library.register_class( 'RenderProcessor', flapi.RenderProcessor )
...
flapi.RenderSetup = class RenderSetup extends flapi.Interface {
...
flapi.library.register_class( 'RenderSetup', flapi.RenderSetup )
...
flapi.Scene = class Scene extends flapi.Interface {
...
flapi.library.register_class( 'Scene', flapi.Scene )
...
flapi.SceneSettings = class SceneSettings extends flapi.Interface {
...
flapi.library.register_class( 'SceneSettings', flapi.SceneSettings )
...
flapi.SequenceDescriptor = class SequenceDescriptor extends flapi.Interface {
...
flapi.library.register_class( 'SequenceDescriptor', flapi.SequenceDescriptor )
...
flapi.Shot = class Shot extends flapi.Interface {
...
flapi.library.register_class( 'Shot', flapi.Shot )
...
flapi.SystemInfo = class SystemInfo extends flapi.Interface {
...
flapi.library.register_class( 'SystemInfo', flapi.SystemInfo )
...
flapi.ThumbnailManager = class ThumbnailManager extends flapi.Interface {
...
flapi.library.register_class( 'ThumbnailManager', flapi.ThumbnailManager )
...
flapi.Timer = class Timer extends flapi.Interface {
...
flapi.library.register_class( 'Timer', flapi.Timer )
...
flapi.Utilities = class Utilities extends flapi.Interface {
...
flapi.library.register_class( 'Utilities', flapi.Utilities )
...
flapi.Volumes = class Volumes extends flapi.Interface {
...
flapi.library.register_class( 'Volumes', flapi.Volumes )
...
flapi.WebConfig = class WebConfig extends flapi.Interface {
...
flapi.library.register_class( 'WebConfig', flapi.WebConfig )
...
flapi.APIPermissionInfo = class APIPermissionInfo {
...
flapi.library.register_value_type( 'APIPermissionInfo', flapi.APIPermissionInfo )
...
flapi.APIUserInfo = class APIUserInfo {
...
flapi.library.register_value_type( 'APIUserInfo', flapi.APIUserInfo )
...
flapi.AudioSequenceSettings = class AudioSequenceSettings {
...
flapi.library.register_value_type( 'AudioSequenceSettings', flapi.AudioSequenceSettings )
...
flapi.AudioSyncProgress = class AudioSyncProgress {
...
flapi.library.register_value_type( 'AudioSyncProgress', flapi.AudioSyncProgress )
...
flapi.AudioSyncSettings = class AudioSyncSettings {
...
flapi.library.register_value_type( 'AudioSyncSettings', flapi.AudioSyncSettings )
...
flapi.BLGExportSettings = class BLGExportSettings {
...
flapi.library.register_value_type( 'BLGExportSettings', flapi.BLGExportSettings )
...
flapi.CDLExportSettings = class CDLExportSettings {
...
flapi.library.register_value_type( 'CDLExportSettings', flapi.CDLExportSettings )
...
flapi.CategoryInfo = class CategoryInfo {
...
flapi.library.register_value_type( 'CategoryInfo', flapi.CategoryInfo )
...
flapi.ColourSpaceInfo = class ColourSpaceInfo {
...
flapi.CubeExportSettings = class CubeExportSettings {
...
flapi.library.register_value_type( 'CubeExportSettings', flapi.CubeExportSettings )
...
flapi.CustomerInfo = class CustomerInfo {
...
flapi.library.register_value_type( 'CustomerInfo', flapi.CustomerInfo )
...
flapi.library.register_value_type( 'DRTInfo', flapi.DRTInfo )
...
flapi.DecodeParameterChoice = class DecodeParameterChoice {
...
flapi.library.register_value_type( 'DecodeParameterChoice', flapi.DecodeParameterChoice )
...
flapi.DecodeParameterDefinition = class DecodeParameterDefinition {
...
flapi.library.register_value_type( 'DecodeParameterDefinition', flapi.DecodeParameterDefinition )
...
flapi.DiagHostResult = class DiagHostResult {
...
flapi.library.register_value_type( 'DiagHostResult', flapi.DiagHostResult )
...
flapi.library.register_value_type( 'DiagInfo', flapi.DiagInfo )
...
flapi.DiagProgress = class DiagProgress {
...
flapi.library.register_value_type( 'DiagProgress', flapi.DiagProgress )
...
flapi.DiagResult = class DiagResult {
...
flapi.library.register_value_type( 'DiagResult', flapi.DiagResult )
...
flapi.DialogItem = class DialogItem {
...
flapi.library.register_value_type( 'DialogItem', flapi.DialogItem )
...
flapi.library.register_value_type( 'EnumInfo', flapi.EnumInfo )
...
flapi.ExportOpInfo = class ExportOpInfo {
...
flapi.library.register_value_type( 'ExportOpInfo', flapi.ExportOpInfo )
...
flapi.ExportProgress = class ExportProgress {
...
flapi.library.register_value_type( 'ExportProgress', flapi.ExportProgress )
...
flapi.FormatBurninItem = class FormatBurninItem {
...
flapi.library.register_value_type( 'FormatBurninItem', flapi.FormatBurninItem )
...
flapi.FormatInfo = class FormatInfo {
...
flapi.library.register_value_type( 'FormatInfo', flapi.FormatInfo )
...
flapi.FormatMapping = class FormatMapping {
...
flapi.library.register_value_type( 'FormatMapping', flapi.FormatMapping )
...
flapi.FormatMask = class FormatMask {
...
flapi.library.register_value_type( 'FormatMask', flapi.FormatMask )
...
flapi.FrameRange = class FrameRange {
...
flapi.library.register_value_type( 'FrameRange', flapi.FrameRange )
...
flapi.KeyTextItem = class KeyTextItem {
...
flapi.library.register_value_type( 'KeyTextItem', flapi.KeyTextItem )
...
flapi.LicenceItem = class LicenceItem {
...
flapi.library.register_value_type( 'LicenceItem', flapi.LicenceItem )
...
flapi.library.register_value_type( 'LookInfo', flapi.LookInfo )
...
flapi.MetadataItem = class MetadataItem {
...
flapi.library.register_value_type( 'MetadataItem', flapi.MetadataItem )
...
flapi.MetadataProperty = class MetadataProperty {
...
flapi.library.register_value_type( 'MetadataProperty', flapi.MetadataProperty )
...
flapi.MultiPasteProgress = class MultiPasteProgress {
...
flapi.library.register_value_type( 'MultiPasteProgress', flapi.MultiPasteProgress )
...
flapi.MultiPasteSettings = class MultiPasteSettings {
...
flapi.library.register_value_type( 'MultiPasteSettings', flapi.MultiPasteSettings )
...
flapi.NewSceneOptions = class NewSceneOptions {
...
flapi.library.register_value_type( 'NewSceneOptions', flapi.NewSceneOptions )
...
flapi.OpenSceneStatus = class OpenSceneStatus {
...
flapi.library.register_value_type( 'OpenSceneStatus', flapi.OpenSceneStatus )
...
flapi.QueueLogItem = class QueueLogItem {
...
flapi.library.register_value_type( 'QueueLogItem', flapi.QueueLogItem )
...
flapi.library.register_value_type( 'QueueOp', flapi.QueueOp )
...
flapi.QueueOpStatus = class QueueOpStatus {
...
flapi.library.register_value_type( 'QueueOpStatus', flapi.QueueOpStatus )
...
flapi.QueueOpTask = class QueueOpTask {
...
flapi.library.register_value_type( 'QueueOpTask', flapi.QueueOpTask )
...
flapi.library.register_value_type( 'Rational', flapi.Rational )
...
flapi.RenderCodecInfo = class RenderCodecInfo {
...
flapi.library.register_value_type( 'RenderCodecInfo', flapi.RenderCodecInfo )
...
flapi.RenderCodecParameterInfo = class RenderCodecParameterInfo {
...
flapi.library.register_value_type( 'RenderCodecParameterInfo', flapi.RenderCodecParameterInfo )
...
flapi.RenderCodecParameterValue = class RenderCodecParameterValue {
...
flapi.library.register_value_type( 'RenderCodecParameterValue', flapi.RenderCodecParameterValue )
...
flapi.RenderDeliverable = class RenderDeliverable {
...
flapi.library.register_value_type( 'RenderDeliverable', flapi.RenderDeliverable )
...
flapi.RenderFileTypeInfo = class RenderFileTypeInfo {
...
flapi.library.register_value_type( 'RenderFileTypeInfo', flapi.RenderFileTypeInfo )
...
flapi.RenderOpInfo = class RenderOpInfo {
...
flapi.library.register_value_type( 'RenderOpInfo', flapi.RenderOpInfo )
...
flapi.RenderProcessorLogItem = class RenderProcessorLogItem {
...
flapi.library.register_value_type( 'RenderProcessorLogItem', flapi.RenderProcessorLogItem )
...
flapi.RenderStatus = class RenderStatus {
...
flapi.library.register_value_type( 'RenderStatus', flapi.RenderStatus )
...
flapi.SceneInfo = class SceneInfo {
...
flapi.library.register_value_type( 'SceneInfo', flapi.SceneInfo )
...
flapi.ScenePath = class ScenePath {
...
flapi.library.register_value_type( 'ScenePath', flapi.ScenePath )
...
flapi.SceneSettingDefinition = class SceneSettingDefinition {
...
flapi.library.register_value_type( 'SceneSettingDefinition', flapi.SceneSettingDefinition )
...
flapi.ShotIndexRange = class ShotIndexRange {
...
flapi.library.register_value_type( 'ShotIndexRange', flapi.ShotIndexRange )
...
flapi.library.register_value_type( 'ShotInfo', flapi.ShotInfo )
...
flapi.StillExportSettings = class StillExportSettings {
...
flapi.library.register_value_type( 'StillExportSettings', flapi.StillExportSettings )
...
flapi.VolumeInfo = class VolumeInfo {
...
flapi.library.register_value_type( 'VolumeInfo', flapi.VolumeInfo )
...
flapi.AUDIOSEQTYPE_NONE = "AST_NONE";
flapi.AUDIOSEQTYPE_FILE = "AST_FILE";
flapi.AUDIOSEQTYPE_STEMS = "AST_STEMS";
flapi.AUDIOSEQTYPE_MOVIE = "AST_MOVIE";
flapi.AUDIOSEQTYPE_TONE = "AST_TONE";
...
flapi.AUDIOSYNCSTATUS_FAIL = "FAIL";
flapi.AUDIOSYNCSTATUS_WARN = "WARN";
flapi.AUDIOSYNCSTATUS_INFO = "INFO";
flapi.AUDIOSYNCSTATUS_NOTE = "NOTE";
flapi.AUDIOSYNCSTATUS_SCAN = "SCAN";
...
flapi.AUDIOSYNC_CRITERIA_TIMECODE = "Timecode";
flapi.AUDIOSYNC_CRITERIA_SRCTIMECODE = "SrcTimecode";
flapi.AUDIOSYNC_CRITERIA_DATESRCTIMECODE = "DateSrcTimecode";
flapi.AUDIOSYNC_CRITERIA_SCENETAKE = "SceneTake";
flapi.AUDIOSYNC_CRITERIA_SHOTSCENETAKE = "ShotSceneTake";
...
flapi.AUDIOSYNC_METADATA_SCENETAKE = "SceneTake";
flapi.AUDIOSYNC_METADATA_DATE = "Date";
...
flapi.AUDIOSYNC_RATIO_1_TO_1 = "1:1";
flapi.AUDIOSYNC_RATIO_1001_TO_1000 = "1001:1000";
flapi.AUDIOSYNC_RATIO_1000_TO_1001 = "1000:1001";
flapi.AUDIOSYNC_RATIO_25_TO_24 = "25:24";
flapi.AUDIOSYNC_RATIO_24_TO_25 = "24:25";
...
flapi.AUDIOSYNC_READLTC_NO = "No";
flapi.AUDIOSYNC_READLTC_CHANNEL = "Channel";
flapi.AUDIOSYNC_READLTC_TRACK = "Track";
...
flapi.AUDIOSYNC_SUBSEARCH_ALL = "All";
flapi.AUDIOSYNC_SUBSEARCH_NAMED = "Named";
flapi.AUDIOSYNC_SUBSEARCH_NEAREST = "Nearest";

// AUDIO_RATE : Audio Sample Rate
//    AUDIO_RATE_44100 : 44.1 kHz
//    AUDIO_RATE_48000 : 48 kHz
//    AUDIO_RATE_96000 : 96 kHz
flapi.AUDIO_RATE_44100 = 44100;
flapi.AUDIO_RATE_48000 = 48000;
flapi.AUDIO_RATE_96000 = 96000;

// BLGEXPORT_LOCKGRADE : Values for BLGExportSettings LockGrade
//    BLGEXPORT_LOCKGRADE_READWRITE : No
//    BLGEXPORT_LOCKGRADE_LOCKED : Yes
flapi.BLGEXPORT_LOCKGRADE_READWRITE = "ReadWrite";
flapi.BLGEXPORT_LOCKGRADE_LOCKED = "Locked";
...
flapi.BLGEXPORT_SCALE_1 = 1;
flapi.BLGEXPORT_SCALE_2 = 2;
flapi.BLGEXPORT_SCALE_4 = 4;
flapi.BLGEXPORT_SCALE_16 = 16;
...
flapi.BURNIN_BORDER_NONE = "none";
flapi.BURNIN_BORDER_RECTANGLE = "rect";
flapi.BURNIN_BORDER_LOZENGE = "loz";
...
flapi.BURNIN_HALIGN_LEFT = 0;
flapi.BURNIN_HALIGN_CENTER = 1;
flapi.BURNIN_HALIGN_RIGHT = 2;

// BURNIN_ITEM_TYPE : Specify burnin item type
//    BURNIN_ITEM_TEXT : Text item
//    BURNIN_ITEM_IMAGE : Image item
flapi.BURNIN_ITEM_TEXT = "text";
flapi.BURNIN_ITEM_IMAGE = "image";
...
flapi.BURNIN_VALIGN_TOP = 0;
flapi.BURNIN_VALIGN_MIDDLE = 1;
flapi.BURNIN_VALIGN_BOTTOM = 2;
...
flapi.CDLEXPORT_CDLLAYER_TOP = "top";
flapi.CDLEXPORT_CDLLAYER_BOTTOM = "bottom";
flapi.CDLEXPORT_CDLLAYER_CUSTOM = "custom";
...
flapi.CDLEXPORT_FORMAT_CC = "CC";
flapi.CDLEXPORT_FORMAT_CCC = "CCC";
...
flapi.CUBEEXPORT_CUBERESOLUTION_DEFAULT = -1;
flapi.CUBEEXPORT_CUBERESOLUTION_16 = 16;
flapi.CUBEEXPORT_CUBERESOLUTION_17 = 17;
flapi.CUBEEXPORT_CUBERESOLUTION_32 = 32;
flapi.CUBEEXPORT_CUBERESOLUTION_33 = 33;
flapi.CUBEEXPORT_CUBERESOLUTION_64 = 64;
...
flapi.CUBEEXPORT_EXTENDEDRANGES_NO = "No";
flapi.CUBEEXPORT_EXTENDEDRANGES_LINEAR = "Linear";
flapi.CUBEEXPORT_EXTENDEDRANGES_LOG = "Log";
...
flapi.CUBEEXPORT_LUT1OPTIONS_INPUT = "Input";
flapi.CUBEEXPORT_LUT1OPTIONS_GRADE = "Grade";
flapi.CUBEEXPORT_LUT1OPTIONS_OUTPUT = "Output";
...
flapi.CUBEEXPORT_LUT2OPTIONS_INPUT = "Input";
flapi.CUBEEXPORT_LUT2OPTIONS_GRADE = "Grade";
flapi.CUBEEXPORT_LUT2OPTIONS_OUTPUT = "Output";
...
flapi.CUBEEXPORT_LUT3OPTIONS_INPUT = "Input";
flapi.CUBEEXPORT_LUT3OPTIONS_GRADE = "Grade";
flapi.CUBEEXPORT_LUT3OPTIONS_OUTPUT = "Output";
...
flapi.CUBEEXPORT_LUTFORMAT_TRUELIGHT = "Truelight";
flapi.CUBEEXPORT_LUTFORMAT_TRUELIGHT_1D = "Truelight_1D";
flapi.CUBEEXPORT_LUTFORMAT_AMIRA = "AMIRA";
flapi.CUBEEXPORT_LUTFORMAT_ARRI = "Arri";
flapi.CUBEEXPORT_LUTFORMAT_AUTODESK = "Autodesk";
flapi.CUBEEXPORT_LUTFORMAT_AUTODESK_1D = "Autodesk_1D";
flapi.CUBEEXPORT_LUTFORMAT_AUTODESK_1DF = "Autodesk_1Df";
flapi.CUBEEXPORT_LUTFORMAT_AUTODESK_MESH = "Autodesk_Mesh";
flapi.CUBEEXPORT_LUTFORMAT_AUTODESK_CTF = "Autodesk_ctf";
flapi.CUBEEXPORT_LUTFORMAT_BMD = "BMD";
flapi.CUBEEXPORT_LUTFORMAT_BARCO = "Barco";
flapi.CUBEEXPORT_LUTFORMAT_BLACKMAGIC = "BlackMagic";
flapi.CUBEEXPORT_LUTFORMAT_BLACKMAGIC_1D = "BlackMagic_1D";
flapi.CUBEEXPORT_LUTFORMAT_CANON_1D = "Canon_1D";
flapi.CUBEEXPORT_LUTFORMAT_CANON_3D = "Canon_3D";
flapi.CUBEEXPORT_LUTFORMAT_CINESPACE = "CineSpace";
flapi.CUBEEXPORT_LUTFORMAT_COLORFRONT_1D = "Colorfront_1D";
flapi.CUBEEXPORT_LUTFORMAT_COLORFRONT_3D = "Colorfront_3D";
flapi.CUBEEXPORT_LUTFORMAT_DVS = "DVS";
flapi.CUBEEXPORT_LUTFORMAT_DVS_1D = "DVS_1D";
flapi.CUBEEXPORT_LUTFORMAT_DAVINCI = "DaVinci";
flapi.CUBEEXPORT_LUTFORMAT_EVERTZ = "Evertz";
flapi.CUBEEXPORT_LUTFORMAT_ICC = "ICC";
flapi.CUBEEXPORT_LUTFORMAT_IRIDAS = "IRIDAS";
flapi.CUBEEXPORT_LUTFORMAT_IRIDAS_1D = "IRIDAS_1D";
flapi.CUBEEXPORT_LUTFORMAT_LUTHER = "LUTher";
flapi.CUBEEXPORT_LUTFORMAT_NUCODA = "Nucoda";
flapi.CUBEEXPORT_LUTFORMAT_PANASONIC = "Panasonic";
flapi.CUBEEXPORT_LUTFORMAT_PANDORA = "Pandora";
flapi.CUBEEXPORT_LUTFORMAT_QUANTEL = "Quantel";
flapi.CUBEEXPORT_LUTFORMAT_QUANTEL_65 = "Quantel_65";
flapi.CUBEEXPORT_LUTFORMAT_SCRATCH = "Scratch";
flapi.CUBEEXPORT_LUTFORMAT_SONY = "Sony";
flapi.CUBEEXPORT_LUTFORMAT_SONY_BVME = "Sony_BVME";
...
flapi.CUBEEXPORT_LUTRESOLUTION_DEFAULT = -1;
flapi.CUBEEXPORT_LUTRESOLUTION_1024 = 1024;
flapi.CUBEEXPORT_LUTRESOLUTION_4096 = 4096;
flapi.CUBEEXPORT_LUTRESOLUTION_16384 = 16384;
...
flapi.CUBEEXPORT_NUMLUTS_1 = 1;
flapi.CUBEEXPORT_NUMLUTS_2 = 2;
flapi.CUBEEXPORT_NUMLUTS_3 = 3;
...
flapi.DECODEPARAMTYPE_INTEGER = "Integer";
flapi.DECODEPARAMTYPE_FLOAT = "Float";
flapi.DECODEPARAMTYPE_BOOLEAN = "Boolean";
flapi.DECODEPARAMTYPE_CHOICE = "Choice";
flapi.DECODEPARAMTYPE_FILE = "File";
...
flapi.DECODEQUALITY_HIGH = "GMDQ_OPTIMISED_UNLESS_HIGH";
flapi.DECODEQUALITY_OPTIMISED = "GMDQ_OPTIMISED";
flapi.DECODEQUALITY_DRAFT = "GMDQ_DRAFT";
...
//    DIAG_SKIP : Skipped
flapi.DIAG_READY = "ready";
flapi.DIAG_WAITING = "waiting";
flapi.DIAG_RUNNING = "running";
flapi.DIAG_PASS = "pass";
flapi.DIAG_WARNING = "warning";
flapi.DIAG_FAILED = "failed";
flapi.DIAG_SKIP = "skipped";

// DIAGWEIGHT : Weight of test
//    DIAGWEIGHT_LIGHT : Light tests
//    DIAGWEIGHT_MEDIUM : Medium tests
//    DIAGWEIGHT_HEAVY : Heavy tests
flapi.DIAGWEIGHT_LIGHT = "DM_LIGHT";
flapi.DIAGWEIGHT_MEDIUM = "DM_MEDIUM";
flapi.DIAGWEIGHT_HEAVY = "DM_HEAVY";
...
flapi.DIT_STRING = "String";
flapi.DIT_INTEGER = "Integer";
...
flapi.DIT_SHOT_SELECTION = "ShotSelection";
flapi.DIT_STATIC_TEXT = "StaticText";
flapi.DIT_SHOT_CATEGORY = "ShotCategory";
flapi.DIT_SHOT_CATEGORY_SET = "CategorySet";
flapi.DIT_MARK_CATEGORY = "MarkCategory";
flapi.DIT_MARK_CATEGORY_SET = "MarkCategorySet";
...
flapi.EXPORTSTATUS_FAIL = "FAIL";
flapi.EXPORTSTATUS_WARN = "WARN";
flapi.EXPORTSTATUS_INFO = "INFO";
flapi.EXPORTSTATUS_NOTE = "NOTE";
flapi.EXPORTSTATUS_SCAN = "SCAN";
...
flapi.EXPORTTYPE_STILL = "Still";
flapi.EXPORTTYPE_BLG = "BLG";
flapi.EXPORTTYPE_CUBE = "Cube";
flapi.EXPORTTYPE_CDL = "CDL";
...
flapi.EXPORT_CATEGORYMATCH_ALL = "all";
flapi.EXPORT_CATEGORYMATCH_ANY = "any";
...
flapi.EXPORT_FRAMES_FIRST = "First";
flapi.EXPORT_FRAMES_POSTER = "Poster";
flapi.EXPORT_FRAMES_MARKED = "Marked";
flapi.EXPORT_FRAMES_CURRENT = "Current";

// EXPORT_OVERWRITE : Values for Exporter Overwrite field
//    EXPORT_OVERWRITE_SKIP : Skip
//    EXPORT_OVERWRITE_REPLACE : Replace
flapi.EXPORT_OVERWRITE_SKIP = "Skip";
flapi.EXPORT_OVERWRITE_REPLACE = "Replace";
...
flapi.EXPORT_SOURCE_ALLSHOTS = "AllShots";
flapi.EXPORT_SOURCE_SELECTEDSHOTS = "SelectedShots";
flapi.EXPORT_SOURCE_CURRENTSHOT = "CurrentShot";
flapi.EXPORT_SOURCE_SHOTSINFILTER = "ShotsInFilter";
flapi.EXPORT_SOURCE_SHOTSOFCATEGORY = "ShotsOfCategory";
...
flapi.EXPORT_STEREO_CURRENT = "Current";
flapi.EXPORT_STEREO_LEFT = "Left";
flapi.EXPORT_STEREO_RIGHT = "Right";
flapi.EXPORT_STEREO_BOTH = "Both";
flapi.EXPORT_STEREO_SINGLESTACKSTEREO = "SingleStackStereo";
...
flapi.FIELDORDER_PROGRESSIVE = "None";
flapi.FIELDORDER_UPPER = "upper";
flapi.FIELDORDER_LOWER = "lower";
...
flapi.FORMATSET_SCOPE_FACTORY = "factory";
flapi.FORMATSET_SCOPE_GLOBAL = "global";
flapi.FORMATSET_SCOPE_JOB = "job";
flapi.FORMATSET_SCOPE_SCENE = "scene";
...
flapi.FSFILTER_FILE = "file";
flapi.FSFILTER_DIR = "directory";
...
flapi.ISMT_FRAME_NUMBER = "FSMT_FRAME_NUMBER";
flapi.ISMT_TIMECODE_1 = "FSMT_TIMECODE_1";
flapi.ISMT_TIMECODE_2 = "FSMT_TIMECODE_2";
flapi.ISMT_KEYCODE_1 = "FSMT_KEYCODE_1";
...
flapi.IMAGETRANSFORM_ADAPTIVE = "adaptive-soft";
flapi.IMAGETRANSFORM_BOX = "box";
flapi.IMAGETRANSFORM_CIRCLE = "circle";
flapi.IMAGETRANSFORM_COMPOSITE = "composite";
flapi.IMAGETRANSFORM_CUBIC = "cubic";
flapi.IMAGETRANSFORM_CUBIC_SPLINE = "cubic-spline";
flapi.IMAGETRANSFORM_LANCZOS = "Lanczos";
flapi.IMAGETRANSFORM_6LANCZOS = "6Lanczos";
flapi.IMAGETRANSFORM_6QUINTIC = "6quintic";
flapi.IMAGETRANSFORM_GAUSSIAN = "Gaussian";
flapi.IMAGETRANSFORM_CATMULL_ROM = "Catmull-Rom";
flapi.IMAGETRANSFORM_SIMON = "Simon";
flapi.IMAGETRANSFORM_LINEAR = "linear";
flapi.IMAGETRANSFORM_NEAREST = "nearest";
flapi.IMAGETRANSFORM_SHARPEDGE = "sharpEdge";
...
flapi.INSERT_START = "start";
flapi.INSERT_END = "end";
flapi.INSERT_BEFORE = "before";
flapi.INSERT_AFTER = "after";
flapi.INSERT_ABOVE = "above";
flapi.INSERT_BELOW = "below";
...
flapi.LOGSEVERITY_HARD = "ERR_HARD";
flapi.LOGSEVERITY_SOFT = "ERR_SOFT";
flapi.LOGSEVERITY_INFO = "ERR_INFO_TRANSIENT";
...
flapi.LUTLOCATION_FILE = "file";
flapi.LUTLOCATION_EMBEDDED = "embedded";
...
flapi.MARKTYPE_TIMELINE = "Timeline";
flapi.MARKTYPE_SHOT = "Shot";
flapi.MARKTYPE_STRIP = "Strip";
...
flapi.MENULOCATION_APP_MENU = "ML_APPMENU";
flapi.MENULOCATION_SCENE_MENU = "ML_SCENE";
flapi.MENULOCATION_EDIT_MENU = "ML_EDIT";
flapi.MENULOCATION_JOB_MANAGER = "ML_JOB_MANAGER";
flapi.MENULOCATION_SHOT_VIEW = "ML_SHOTS_VIEW";
...
flapi.MULTIPASTESTATUS_FAIL = "FAIL";
flapi.MULTIPASTESTATUS_WARN = "WARN";
flapi.MULTIPASTESTATUS_INFO = "INFO";
flapi.MULTIPASTESTATUS_NOTE = "NOTE";
flapi.MULTIPASTESTATUS_SCAN = "SCAN";
...
flapi.MULTIPASTE_BLGRESOURCECONFLICT_REPLACE = "Replace";
flapi.MULTIPASTE_BLGRESOURCECONFLICT_ORIGINAL = "Original";
flapi.MULTIPASTE_BLGRESOURCECONFLICT_RENAME = "Rename";
...
flapi.MULTIPASTE_DESTSELECTION_SELECTEDSTRIPS = "SelectedStrips";
flapi.MULTIPASTE_DESTSELECTION_SELECTEDSHOTS = "SelectedShots";
...
flapi.MULTIPASTE_DESTSHOTS_OVERWRITEALL = "OverwriteAll";
flapi.MULTIPASTE_DESTSHOTS_OVERWRITEALLEXCEPTCATS = "OverwriteAllExceptCats";
flapi.MULTIPASTE_DESTSHOTS_RETAINALL = "RetainAll";
flapi.MULTIPASTE_DESTSHOTS_RETAINALLEXCEPTCATS = "RetainAllExceptCats";
...
flapi.MULTIPASTE_EDLAPPLYASCCDL_NO = "No";
flapi.MULTIPASTE_EDLAPPLYASCCDL_CDL = "CDL";
...
flapi.MULTIPASTE_LAYERZEROBEHAVIOUR_STACKONLY = "StackOnly";
flapi.MULTIPASTE_LAYERZEROBEHAVIOUR_LAYERZEROANDSTACK = "LayerZeroAndStack";
flapi.MULTIPASTE_LAYERZEROBEHAVIOUR_LAYERZEROONLY = "LayerZeroOnly";
flapi.MULTIPASTE_LAYERZEROBEHAVIOUR_NOLAYERS = "NoLayers";
...
flapi.MULTIPASTE_LAYERZEROCATEGORIES_INCLUDE = "Include";
flapi.MULTIPASTE_LAYERZEROCATEGORIES_OVERWRITE = "Overwrite";
flapi.MULTIPASTE_LAYERZEROCATEGORIES_NO = "No";
...
flapi.MULTIPASTE_MATCHBY_TAPENAME = "TapeName";
flapi.MULTIPASTE_MATCHBY_FILENAME = "Filename";
flapi.MULTIPASTE_MATCHBY_CLIPNAME = "ClipName";
flapi.MULTIPASTE_MATCHBY_AVIDUID = "AvidUID";
flapi.MULTIPASTE_MATCHBY_CAMERA = "Camera";
flapi.MULTIPASTE_MATCHBY_BLGNAME = "BLGName";
flapi.MULTIPASTE_MATCHBY_BLGID = "BLGId";
flapi.MULTIPASTE_MATCHBY_SCENE = "Scene";
flapi.MULTIPASTE_MATCHBY_SCENETAKE = "SceneTake";
flapi.MULTIPASTE_MATCHBY_CAMERAROLL = "CameraRoll";
flapi.MULTIPASTE_MATCHBY_LABROLL = "LabRoll";
flapi.MULTIPASTE_MATCHBY_LUT = "LUT";
flapi.MULTIPASTE_MATCHBY_LUT2 = "LUT2";
flapi.MULTIPASTE_MATCHBY_ASC_CC_XML = "ASC_CC_XML";
flapi.MULTIPASTE_MATCHBY_FRAMENUMBER = "FrameNumber";
flapi.MULTIPASTE_MATCHBY_TIMECODE = "Timecode";
flapi.MULTIPASTE_MATCHBY_KEYCODE = "Keycode";
flapi.MULTIPASTE_MATCHBY_RECORDFRAMENUMBER = "RecordFrameNumber";
flapi.MULTIPASTE_MATCHBY_RECORDTIMECODE = "RecordTimecode";
flapi.MULTIPASTE_MATCHBY_ALWAYSMATCH = "AlwaysMatch";
...
flapi.MULTIPASTE_MATCHQUALITY_EXACTMATCH = "ExactMatch";
flapi.MULTIPASTE_MATCHQUALITY_FUZZYMATCH = "FuzzyMatch";
...
flapi.MULTIPASTE_PASTELOCATION_ABOVE = "Above";
flapi.MULTIPASTE_PASTELOCATION_BELOW = "Below";
...
flapi.MULTIPASTE_SOURCE_COPYBUFFER = "CopyBuffer";
flapi.MULTIPASTE_SOURCE_MULTIPLESCENES = "MultipleScenes";
flapi.MULTIPASTE_SOURCE_BLG = "BLG";
flapi.MULTIPASTE_SOURCE_LUT = "LUT";
flapi.MULTIPASTE_SOURCE_CDL = "CDL";
flapi.MULTIPASTE_SOURCE_EDL = "EDL";
...
flapi.MULTIPASTE_SOURCESHOTS_COPYALL = "CopyAll";
flapi.MULTIPASTE_SOURCESHOTS_COPYALLEXCEPTCATS = "CopyAllExceptCats";
flapi.MULTIPASTE_SOURCESHOTS_COPYONLYCATS = "CopyOnlyCats";
...
flapi.OPENFLAG_DISCARD = "discard";
flapi.OPENFLAG_RECOVER = "recover";
flapi.OPENFLAG_OLD = "openold";
flapi.OPENFLAG_IGNORE_REVISION = "ignorerevision";
flapi.OPENFLAG_READ_ONLY = "readonly";
flapi.OPENFLAG_ALLOW_UNKNOWN_OFX = "allow_unknown_openfx";
flapi.OPENFLAG_NO_CONTAINER_WARNING = "nocontainerwarning";
...
flapi.OPERATOR_BARS_TYPE_RP219HD_2a3a = "RP219HD_2a3a";
flapi.OPERATOR_BARS_TYPE_RP219HD_2b3a = "RP219HD_2b3a";
flapi.OPERATOR_BARS_TYPE_RP219HD_2c3b = "RP219HD_2c3b";
flapi.OPERATOR_BARS_TYPE_RP219HD_2d3b = "RP219HD_2d3b";
flapi.OPERATOR_BARS_TYPE_GREYS17 = "GREYS17";
flapi.OPERATOR_BARS_TYPE_RAMP = "RAMP";
flapi.OPERATOR_BARS_TYPE_RGBGREY = "RGBGREY";
flapi.OPERATOR_BARS_TYPE_B72 = "B72";
flapi.OPERATOR_BARS_TYPE_ITU2111_PQ = "ITU2111_PQ";
flapi.OPERATOR_BARS_TYPE_B66_4K = "B66_4K";
flapi.OPERATOR_BARS_TYPE_B66_8K = "B66_8K";
...
flapi.OPSTATUS_CREATING = "Creating";
flapi.OPSTATUS_QUEUED = "Queued";
flapi.OPSTATUS_ACTIVE = "Active";
flapi.OPSTATUS_CRASHED = "Crashed";
flapi.OPSTATUS_STOPPED = "Stopped";
flapi.OPSTATUS_TOONEW = "Too New";
flapi.OPSTATUS_DONE = "Done";
...
flapi.OFLOWQUAL_BEST = "Best";
flapi.OFLOWQUAL_HIGH = "High";
flapi.OFLOWQUAL_MEDIUM = "Medium";
...
flapi.OFLOWSMOOTH_NONE = 0;
flapi.OFLOWSMOOTH_LOW = 1;
flapi.OFLOWSMOOTH_MEDIUM = 2;
flapi.OFLOWSMOOTH_HIGH = 3;
flapi.OFLOWSMOOTH_MAX = 4;
...
flapi.RES_HIGH = "GMPR_HIGH";
flapi.RES_MEDIUM = "GMPR_MEDIUM";
flapi.RES_LOW = "GMPR_LOW";
...
flapi.QUEUELOGTYPE_INFO = "info";
flapi.QUEUELOGTYPE_WARN = "warn";
flapi.QUEUELOGTYPE_FAIL = "fail";
...
flapi.RENDER_CLIPNAME_FILE = 0;
flapi.RENDER_CLIPNAME_SHOT = 1;
flapi.RENDER_CLIPNAME_STRIP = 2;
...
flapi.RENDER_COLOURSPACE_USEINPUT = "Input";
flapi.RENDER_COLOURSPACE_USESTACKOUTPUT = "None";
...
flapi.RENDER_EMPTY_FAIL = "GMREB_FAIL";
flapi.RENDER_EMPTY_BLACK = "GMREB_BLACK";
flapi.RENDER_EMPTY_CHEQUER = "GMREB_CHEQUER";
...
flapi.RENDER_ERROR_FAIL = "ABORT";
flapi.RENDER_ERROR_SKIP = "SKIP";
flapi.RENDER_ERROR_BLACK = "BLACK";
flapi.RENDER_ERROR_CHEQUER = "CHEQUER";

// RENDER_FORMAT : Special values to use for RenderFormat in RenderDeliverable
//    RENDER_FORMAT_USEINPUT : Use Shot Input Format
flapi.RENDER_FORMAT_USEINPUT = "0";
...
flapi.RENDER_FRAMENUM_SCENE_FRAME = "F";
flapi.RENDER_FRAMENUM_SHOT_FRAME = "G";
flapi.RENDER_FRAMENUM_SCENE_TIMECODE = "T";
flapi.RENDER_FRAMENUM_SHOT_TIMECODE = "H";
...
flapi.RENDER_INCOMPLETE_FAIL = "GMREB_FAIL";
flapi.RENDER_INCOMPLETE_CONTINUE = "GMREB_CONTINUE";
flapi.RENDER_INCOMPLETE_BLACK = "GMREB_BLACK";
flapi.RENDER_INCOMPLETE_CHEQUER = "GMREB_CHEQUER";
...
flapi.RENDER_LAYER_ALL = -1;
flapi.RENDER_LAYER_LAYERS_INPUTONLY = -2;
flapi.RENDER_LAYER_LAYER0 = 0;
...
flapi.RENDER_MASK_CROP = -1;
flapi.RENDER_MASK_BLACK = 0;
flapi.RENDER_MASK_VIDEO = 64;
flapi.RENDER_MASK_FILM = 95;
...
flapi.RENDER_NCLC_LEGACY = 0;
flapi.RENDER_NCLC_AUTOMATIC = 1;
...
flapi.RENDER_TAPENAME_FILE = 0;
flapi.RENDER_TAPENAME_SHOT = 1;
flapi.RENDER_TAPENAME_CLIP = 3;
flapi.RENDER_TAPENAME_STRIP = 2;
...
flapi.RENDER_TIMECODE_FILETC1 = 0;
flapi.RENDER_TIMECODE_FILETC2 = 3;
flapi.RENDER_TIMECODE_SHOTTC = 2;
flapi.RENDER_TIMECODE_RECTC = 1;

// ROP_TEXT_ALIGN : Text alignment
//    ROP_TEXT_ALIGN_LEFT : Left
//    ROP_TEXT_ALIGN_CENTER : Center
//    ROP_TEXT_ALIGN_RIGHT : Right
flapi.ROP_TEXT_ALIGN_LEFT = 0;
flapi.ROP_TEXT_ALIGN_CENTER = 1;
flapi.ROP_TEXT_ALIGN_RIGHT = 2;
...
flapi.SEQRESAMPLE_SNAP_TO_FRAME = "SnapToFrame";
flapi.SEQRESAMPLE_ROLLING_MAX = "RollingMix";
flapi.SEQRESAMPLE_OPTICAL_FLOW = "OpticalFlow";

// STEREO_EYE : Stereo eye
//    STEREOEYE_MONO : Mono (no stereo)
//    STEREOEYE_LEFT : Left eye
//    STEREOEYE_RIGHT : Right eye
flapi.STEREOEYE_MONO = "GMSE_MONO";
flapi.STEREOEYE_LEFT = "GMSE_LEFT";
flapi.STEREOEYE_RIGHT = "GMSE_RIGHT";
...
flapi.STILLEXPORT_DECODEQUALITY_GMDQ_OPTIMISED_UNLESS_HIGH = "GMDQ_OPTIMISED_UNLESS_HIGH";
flapi.STILLEXPORT_DECODEQUALITY_GMDQ_OPTIMISED = "GMDQ_OPTIMISED";
flapi.STILLEXPORT_DECODEQUALITY_GMDQ_DRAFT = "GMDQ_DRAFT";
...
flapi.STILLEXPORT_MASKMODE_CROP = "Crop";
flapi.STILLEXPORT_MASKMODE_HARDBLACK = "HardBlack";
flapi.STILLEXPORT_MASKMODE_VIDEOBLACK = "VideoBlack";
flapi.STILLEXPORT_MASKMODE_FILMBLACK = "FilmBlack";
...
flapi.SVGFITMODE_NONE = "None";
flapi.SVGFITMODE_BEST = "Best";
flapi.SVGFITMODE_STRETCH = "Stretch";
...
flapi.VIDEOLUT_NONE = "none";
flapi.VIDEOLUT_SCALE = "scale";
flapi.VIDEOLUT_SCALE_NOCLIP = "scalenoclip";
flapi.VIDEOLUT_UNSCALE = "unscale";
flapi.VIDEOLUT_FULLRANGE_SOFTCLIP = "fullrangesoftclip";
flapi.VIDEOLUT_CLIP = "clip";
flapi.VIDEOLUT_SOFTCLIP = "softclip";
